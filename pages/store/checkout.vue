                  ...
                  <table class="table table-compact w-full">
                    <tbody class="">
                      <tr>
                        ...
                        <td class="py-1 pb-0 text-lg border-transparent text-end bg-transparent">${{ floor2Decimals(cartStore.getCartTotalPrice).toFixed(2) }}</td>
                      </tr>
                      <tr>
                        ...
                        <td class="py-1 pt-0 text-lg text-end border-b-2 border-gray-500 bg-transparent"> <strong>${{ floor2Decimals(cartStore.getCartTotalPrice).toFixed(2) }}</strong></td>
                      </tr>
                      <tr>
                        <td class="pl-0 py-1 pb-0 text-base border-transparent text-start bg-transparent">{{`Tax (${taxPercentage * 100}%)`}}</td>
                        <td class="py-1 pb-0 text-lg border-transparent text-end bg-transparent">${{ floor2Decimals(cartStore.getCartTotalPrice * taxPercentage).toFixed(2) }}</td>
                      </tr>
                      <tr>
                        <td class="pl-0 py-1 pt-0 text-base border-b-2 border-gray-500 text-start bg-transparent">Shipping fees</td>
                        <td class="py-1 pt-0 text-lg border-b-2 border-gray-500 text-end bg-transparent">${{ floor2Decimals(store_order?.shipping_method?.price).toFixed(2) }}</td>
                      </tr>
                      <tr>
                        ...
                        <td class="py-2 text-lg text-end border-transparent bg-transparent"> <strong>${{ floor2Decimals(cartStore.getCartTotalPrice * (1+taxPercentage) + Number(store_order?.shipping_method?.price)).toFixed(2) }}</strong></td>
                      </tr>
                    </tbody>
                  </table>
                </div>
