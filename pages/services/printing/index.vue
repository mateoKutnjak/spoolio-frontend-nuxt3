<template>
  <div class="container mx-auto">
    <div v-if="filamentInfillStore.getFilamentInfills.length && filamentSpoolStore.getAll.length">
    ...
    <div
      v-else
      class="absolute z-50 top-0 bottom-0 right-0 left-0 bg-gray-400/40 flex flex-col justify-center items-center"
    >
      <Icon
