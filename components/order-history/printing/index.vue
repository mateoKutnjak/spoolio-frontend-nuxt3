      ...
      <table class="table-auto w-full">
        <thead class="rounded-lg">
          <tr class="bg-base-200">
            ...
            <th class="px-4 pt-4 pb-3 text-center uppercase">{{ capitalizeOnlyFirstLetter($t('customer_info')) }}</th>
    ...
    <div class="hero h-96">
      <div class="hero-content text-center text-gray-400">
        <div class="max-w-md">
          ...
          <NuxtLink :to="localePath('/services/printing')">
...
function onItemClicked(order: IPrintOrder) {
  navigateTo(localePath(`/profile/order-history/printing/${order.id}`));
}
</script>
