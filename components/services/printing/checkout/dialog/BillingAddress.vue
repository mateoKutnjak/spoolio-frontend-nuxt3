...
onMounted(() => {
  ...
  if (Object.keys(print_order.value.billing_address).length) {
    type.value =
      print_order.value.billing_address.type || BILLING_ADDRESS_TYPE_INDIVIDUAL;
    ...
    contactFirstName.value =
      print_order.value.billing_address.contact_first_name || "";
    contactLastName.value =
      print_order.value.billing_address.contact_last_name || "";
    companyName.value = print_order.value.billing_address.company_name || "";
    vatId.value = print_order.value.billing_address.vat_id || "";
...
function submitHandler() {
  ...
  print_order.value.billing_address.type = type.value;
  ...
  print_order.value.billing_address.contact_first_name = contactFirstName.value;
  print_order.value.billing_address.contact_last_name = contactLastName.value;
  print_order.value.billing_address.company_name = companyName.value;
  print_order.value.billing_address.vat_id = vatId.value;
