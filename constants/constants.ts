...
export const HTTP_3D_MODEL_POST_REQUEST_TIMEOUT = 45_000;
export const TIMEOUT_WS_SLICER_ESTIMATION_INIT_MESSAGE = 5_000;
export const TIMEOUT_WS_SLICER_ESTIMATION_DATA_MESSAGE = 80_000;
export const TIMEOUT_WS_PRINT_JOB_ETA_ESTIMATION_DATA_MESSAGE = 10_000;
...
export const MAX_FILE_SIZE_STL = 20 * 1024 * 1024 // MB
